            ...
            <div className="p-12 shadow-lg border-2 rounded-lg bg-slate-100 mx-4">
                ...
                <div className="mt-12">
                    <div>
                        ...
                        <input type="email" name="email" id="email" className="px-4 py-2 bg-slate-300 rounded-md mb-8 mt-2 w-full" /> <br />
                        <label htmlFor="password" className="font-semibold">Senha</label> <br />
                        <input type="password" name="password" id="password" className="px-4 py-2 bg-slate-300 rounded-md mb-8 mt-2 w-full" />
                    </div>
                    <a href="#" className="font-semibold underline text-purple-600 mb-2 ">Esqueci minha senha</a> <br />  
                    <button className={inter.className+" mt-12 bg-purple-600 w-full rounded-md text-center py-2 text-slate-50"}>Acessar</button>
                </div>
            </div>
        </main>
    )
